...
const SOURCES: SourceItem[] = [
  ...
  {
    feature: "แชทบอทผู้ช่วย น้องมู",
    href: "/",
    level: "ผสม",
    basis: "Google Gemini",
    detail:
      "เป็น AI ที่ทำหน้าที่ไกด์ของเว็บและอธิบายศัพท์โหราศาสตร์เท่านั้น มีคำสั่งกำกับไว้ว่าห้ามแต่งคำทำนายเอง ถ้าถูกขอให้ดูดวงจะชวนไปหน้าที่คำนวณจริงแทน ข้อมูลเรื่องเว็บที่บอทรู้ประกอบขึ้นจากไลบรารีชุดเดียวกับที่หน้าเว็บใช้ จึงตรงกันเสมอ แต่ AI ก็ยังตอบผิดได้ ถ้าคำตอบขัดกับหน้าเว็บให้เชื่อหน้าเว็บ",
  },
  {
    feature: "แท็บมาแรง",
    href: "/",
    ...
    basis: "ยอดเข้าดูจริง",
    detail:
      "ไม่ใช่คำทำนาย แต่เป็นตัวเลขจริงจากการนับว่าแต่ละหน้าถูกเปิดกี่ครั้ง เก็บเป็นยอดรวมต่อหน้าเท่านั้น ไม่ได้เก็บว่าใครเปิด ไม่ผูกกับบัญชีผู้ใช้ และไม่ได้ใช้ตัวเลขนี้ไปคำนวณดวงของใคร",
  },
];
